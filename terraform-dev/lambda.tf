...
# ─────────────────────────────────────────────────────────────
# Daily support emailer Lambda (dev)
# ─────────────────────────────────────────────────────────────
resource "aws_lambda_function" "support_emailer" {
  function_name = "support-emailer-dev"
  description   = "Sends support emails to users who only had failed sessions today (dev)"
...
resource "aws_cloudwatch_event_rule" "support_email_schedule" {
  name                = "support-email-daily-dev"
  description         = "Send support emails to failed-session users at 6pm IST (dev)"
