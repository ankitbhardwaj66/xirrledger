...
image: "/blog/are-you-beating-nifty50.webp"
keywords:
  - beating Nifty 50
  - XIRR vs Nifty 50
...
But here's the truth — a large share of retail investors struggle to consistently beat a simple Nifty 50 index fund over the long run. Not because they're bad at picking stocks, but because they're comparing the wrong things. They compare their portfolio returns without asking: *what would the same money have earned in Nifty 50 over the same period?*
...
**Quick Answer:** To honestly check if you're beating Nifty 50, you can't just compare your XIRR to a published annual index return — you need to mirror your exact cash flows into Nifty 50 and calculate what that portfolio would be worth today. Every time you deposited money into your broker account, assume you bought Nifty 50 units on that exact date; every withdrawal is a sale. The Nifty 50 XIRR on those same deposits and withdrawals is the only fair benchmark. If your portfolio XIRR exceeds it, you genuinely outperformed; if it falls short, you would have earned more in a simple index fund.
...
And the most important alternative for any Indian investor is Nifty 50 — the benchmark that represents the Indian market's overall performance ([Nifty 50 index return profile, NSE Indices](https://www.niftyindices.com/market-data/return-profile)).
...
**Ready to find out if you're beating Nifty 50?** [Calculate Your XIRR →](https://xirrledger.com/calculator/)
