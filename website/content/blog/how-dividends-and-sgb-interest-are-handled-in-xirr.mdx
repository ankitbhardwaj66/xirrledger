...
image: "/blog/dividends-sgb-xirr.webp"
keywords:
...
If your goal is to know whether you're beating an index like Nifty 50, you need to compare like-for-like. The Nifty 50 Total Return Index (TRI) reinvests dividends back into the index, which is why SEBI requires mutual funds to be benchmarked against the TRI variant ([Nifty 50 TRI, NSE Indices](https://www.niftyindices.com/market-data/return-profile)). If your XIRR doesn't include dividends, you're comparing an incomplete number to a complete benchmark — and you'll always look worse than you actually are.

The same logic applies to other income that never touches your broker ledger — SGB interest, RBI bond coupons, and other off-ledger assets all need to be added back to get an honest number (more on that in [how broker XIRR misses SGBs, govt bonds and unlisted stocks](/blog/broker-xirr-misses-sgb-govt-bonds-unlisted-stocks/)).
