...
image: "/blog/broker-xirr-missing-investments.webp"
keywords:
  - broker XIRR wrong
...
If you're comparing your returns against a long-run Nifty 50 XIRR (historically in the low double digits), even a 1-point distortion can be the difference between "I beat the index" and "I matched it."
