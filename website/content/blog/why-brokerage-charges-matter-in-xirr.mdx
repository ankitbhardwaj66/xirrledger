...
image: "/blog/brokerage-charges-xirr.webp"
keywords:
...
These statutory rates are published by the exchanges: STT, exchange transaction charges and SEBI turnover fees on the [NSE SEBI turnover fees, STT and other levies page](https://www.nseindia.com/static/invest/first-time-investor-sebi-turnover-fees-stt-other-levies), and stamp duty on the [NSE stamp duty page](https://www.nseindia.com/static/invest/first-time-investor-stamp-duty-charges-taxes). (Some derivative STT rates were revised in recent Finance Acts, so always confirm the current schedule for F&O.)
