    ...
    <footer className="bg-gray-900 text-white">
      <div className="container-custom py-12">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center space-y-2">
          <p className="text-gray-400 text-sm">
            © {currentYear} XIRR Ledger by <a href="https://ankitbhardwaj.in" target="_blank" rel="noopener noreferrer" className="text-white underline hover:text-primary-light transition">Ankit Bhardwaj</a>. All rights reserved.
          </p>
