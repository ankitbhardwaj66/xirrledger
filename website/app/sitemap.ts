...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    { url: `${BASE_URL}/`,                        lastModified: '2026-05-11' },
    { url: `${BASE_URL}/how-it-works/`,           lastModified: '2026-05-11' },
    { url: `${BASE_URL}/features/`,               lastModified: '2026-03-15' },
    { url: `${BASE_URL}/blog/`,                   lastModified: posts[0]?.lastModified ?? posts[0]?.date ?? '2026-05-11' },
    { url: `${BASE_URL}/how-to-calculate-xirr/`,  lastModified: '2026-05-07' },
    { url: `${BASE_URL}/faq/`,                    lastModified: '2026-05-11' },
