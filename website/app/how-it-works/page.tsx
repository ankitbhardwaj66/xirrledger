...
const steps = [
  {
    ...
    description: 'Export your trading ledger from your broker\'s website. For Zerodha, download the CSV from Funds → View Statement. For Groww, download PDF statements for each year. For Fyers, go to Reports → Ledger, select the financial year, and download CSV.',
